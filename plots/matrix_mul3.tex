...
\draw[thick,red,->] (A-1-1.north) -- (A-3-1.south); 
\draw[thick,red,->] (A-1-2.north) -- (A-3-2.south); 
\draw[thick,red,->] (A-1-3.north) -- (A-3-3.south); 
\draw[thick,red,->] (B-1-2.north) -- (B-3-2.south); 
\draw[thick,red,->] (C-1-2.north) -- (C-3-2.south); 
